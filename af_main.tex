...
Therefore, in the following analysis, we assume $\underline{Y}$ follows Gaussian distribution $\mathcal{N}(\mathbf{0},\frac{1}{n} \mathbf{I}_n)$ and
...
We also assume that $\underline{Y}$ and $\bm{X}$ are independent.
...
Based on such choice, for linear function, we have the following conclusion:
