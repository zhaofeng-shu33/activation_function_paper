...
To design a good neural network requires not only the inner structure of each layer but the layer to layer activation. The current approach to choose
activation function is mostly empirically motivated.
For example, there have been empirical works which propose methods to optimize over parameterized activation function together with network weight \cite{ramachandran2017searching}.
