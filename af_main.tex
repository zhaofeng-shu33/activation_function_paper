...
For example, we could optimize over parameterized activation function together with network weight to obtain desirable activation function \cite{ramachandran2017searching}.
However, to balance the training efficiency and network performance, the activation function family can not be too complex \cite{laudani2015training}. The searched activation
