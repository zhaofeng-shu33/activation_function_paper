...
To get rid of the influence of $\epsilon$, we consider the limit of $\epsilon \to 0$ and we have the concept of the index of averaged estimation error.
\begin{definition}
Let
\begin{equation}
C = \lim_{\epsilon \to 0} \min_{\sigma \in F(\epsilon)} \frac{E[\sigma] - E[\sigma_0]}{\epsilon^2}
\end{equation}
$C$ is called the index of averaged estimation error.
\end{definition}

$C[\sigma]$ can represent the optimal direction of purterbation from linear function.
If $C< 0 $ then we can choose certain $\epsilon'$ and $\sigma'$ such that $E[\sigma'] < E[\sigma_0] - \frac{1}{2}C\epsilon'^2$.
