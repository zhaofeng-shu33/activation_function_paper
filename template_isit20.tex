...
There are many choices for activation function \cite{laudani2015training} and none of them performs best for all problems. There are also empirical works which optimize over parameterized activation function together with network weight \cite{ramachandran2017searching}.
